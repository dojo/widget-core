...
export class Base<P = WidgetProperties, C extends DNode = DNode> extends Evented implements WidgetBaseInterface<P, C> {
	...
	private _checkOnElementUsage() {
		...
		if (this.onElementCreated !== Base.prototype.onElementCreated) {
		...
		if (this.onElementUpdated !== Base.prototype.onElementUpdated) {
